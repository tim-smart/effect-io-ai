...
```ts
declare const remove: { <V>(value: V): (self: TxHashSet<V>) => Effect.Effect<boolean, never, Effect.Transaction>; <V>(self: TxHashSet<V>, value: V): Effect.Effect<boolean, never, Effect.Transaction>; }
```
