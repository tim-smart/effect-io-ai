...
```ts
declare const withDefault: <T>(defaultValue: () => T) => Getter<T, T | undefined>
```

[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/SchemaGetter.ts#L693)
