...
```ts
declare const remainingUnsafe: <A>(self: Subscription<A>) => number | undefined
```

[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/PubSub.ts#L1318)
