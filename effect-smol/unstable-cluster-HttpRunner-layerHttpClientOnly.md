...
```ts
declare const layerHttpClientOnly: Layer.Layer<Sharding.Sharding | Runners.Runners, never, HttpClient.HttpClient | MessageStorage | RunnerStorage | ShardingConfig.ShardingConfig | RpcSerialization.RpcSerialization>
```
