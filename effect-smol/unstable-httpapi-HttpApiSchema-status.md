...
```ts
declare const status: (code: number) => <S extends Schema.Top>(self: S) => S["~rebuild.out"]
```

[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/HttpApiSchema.ts#L88)
