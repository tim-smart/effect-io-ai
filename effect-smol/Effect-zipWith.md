...
The `zipWith` function is similar to `zip`, but instead of returning a
...
[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/Effect.ts#L2650)
