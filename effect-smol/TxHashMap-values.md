...
```ts
declare const values: <K, V>(self: TxHashMap<K, V>) => Effect.Effect<Array<V>, never, Effect.Transaction>
```

[Source](https://github.com/Effect-TS/effect-smol/tree/main/packages/effect/src/TxHashMap.ts#L862)
